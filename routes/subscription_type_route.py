...
from init_controllers import subscription_type_controller
...
def get_subscription_types():
    subscription_types = subscription_type_controller.get_sub_types()
    result = []
...
def get_subscription_type(subscription_type_id):
    subscription_type = subscription_type_controller.get_sub_type(subscription_type_id)
